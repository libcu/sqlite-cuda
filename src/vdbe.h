...
SQLITE_METHOD u8 sqlite3VdbePrepareFlags(Vdbe*);
SQLITE_METHOD void sqlite3VdbeSetSql(Vdbe*, const char *z, int n, u8);
...
SQLITE_METHOD int sqlite3NotPureFunc(sqlite3_context*);
