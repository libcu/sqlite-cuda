...
int main(int argc, char **argv){
  ...
  ** number of collisions */
  ...
  printf("static SQLITE_CONSTANT const char zKWText[%d] = {\n", nChar);
  zKWText[nChar] = 0;
  for(i=j=0; i<k; i++){
    if( j==0 ){
      printf("  ");
  ...
  printf("static SQLITE_CONSTANT const unsigned char aKWHash[%d] = {\n", bestSize);
  ...
  printf("static SQLITE_CONSTANT const unsigned char aKWNext[%d] = {\n", nKeyword);
  for(i=j=0; i<nKeyword; i++){
    if( j==0 ) printf("  ");
  ...
  printf("static SQLITE_CONSTANT const unsigned char aKWLen[%d] = {\n", nKeyword);
  for(i=j=0; i<nKeyword; i++){
    if( j==0 ) printf("  ");
  ...
  printf("static SQLITE_CONSTANT const unsigned short int aKWOffset[%d] = {\n", nKeyword);
  for(i=j=0; i<nKeyword; i++){
    if( j==0 ) printf("  ");
  ...
  printf("static SQLITE_CONSTANT const unsigned char aKWCode[%d] = {\n", nKeyword);
  for(i=j=0; i<nKeyword; i++){
  ...
  printf("static SQLITE_METHOD int keywordCode(const char *z, int n, int *pType){\n");
  printf("  int i, j;\n");
  ...
  printf("  return n;\n");
  printf("}\n");
  printf("SQLITE_METHOD int sqlite3KeywordCode(const unsigned char *z, int n){\n");
  printf("  int id = TK_ID;\n");
