...
*/
static SQLITE_METHOD void disableLookaside(Parse *pParse){
...
%include {
  ...
  */
  static SQLITE_METHOD void parserDoubleLinkSelect(Parse *pParse, Select *p){
    if( p->pPrior ){
...
%include {
  ...
  */
  static SQLITE_METHOD Expr *tokenExpr(Parse *pParse, int op, Token t){
...
%include {
  ...
  ** unary TK_ISNULL or TK_NOTNULL expression. */
  static SQLITE_METHOD void binaryToUnaryIfNull(Parse *pParse, Expr *pY, Expr *pA, int op){
...
%include {
  ...
  */
  static SQLITE_METHOD ExprList *parserAddExprIdListTerm(
    Parse *pParse,
    ExprList *pPrior,
    Token *pIdToken,
    int hasCollate,
