...
extern SQLITE_METHOD int getDbPointer(Tcl_Interp *, const char *, sqlite3 **);

static SQLITE_METHOD int SQLITE_TCLAPI backupTestCmd(
...
static SQLITE_METHOD void SQLITE_TCLAPI backupTestFinish(ClientData clientData){
...
**
*/
static SQLITE_METHOD int SQLITE_TCLAPI backupTestInit(
  ClientData clientData, 
  Tcl_Interp *interp, 
  int objc,
  Tcl_Obj *const*objv
...
SQLITE_METHOD int Sqlitetestbackup_Init(Tcl_Interp *interp){
