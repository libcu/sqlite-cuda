...
extern SQLITE_METHOD const char *sqlite3ErrName(int);

/* From test1.c: */
extern SQLITE_METHOD int getDbPointer(Tcl_Interp *interp, const char *zA, sqlite3 **ppDb);
extern SQLITE_METHOD void *sqlite3TestTextToPtr(const char *z);
...
*/
static SQLITE_METHOD char *ptrToText(void *p){
  static char buf[100];
...
*/
static SQLITE_METHOD int blobHandleFromObj(
  Tcl_Interp *interp, 
  Tcl_Obj *pObj,
  sqlite3_blob **ppBlob
){
...
*/
static SQLITE_METHOD char *blobStringFromObj(Tcl_Obj *pObj){
  int n;
  char *z;
  z = Tcl_GetStringFromObj(pObj, &n);
  return (n ? z : 0);
...
*/
static SQLITE_METHOD int SQLITE_TCLAPI test_blob_open(
...
*/
static SQLITE_METHOD int SQLITE_TCLAPI test_blob_close(
  ClientData clientData, /* Not used */
...
*/
static SQLITE_METHOD int SQLITE_TCLAPI test_blob_bytes(
  ClientData clientData, /* Not used */
  Tcl_Interp *interp,    /* The TCL interpreter that invoked this command */
  int objc,              /* Number of arguments */
  Tcl_Obj *CONST objv[]  /* Command arguments */
...
*/
static SQLITE_METHOD int SQLITE_TCLAPI test_blob_read(
  ClientData clientData, /* Not used */
  Tcl_Interp *interp,    /* The TCL interpreter that invoked this command */
  int objc,              /* Number of arguments */
  Tcl_Obj *CONST objv[]  /* Command arguments */
...
*/
static SQLITE_METHOD int SQLITE_TCLAPI test_blob_write(
  ClientData clientData, /* Not used */
  Tcl_Interp *interp,    /* The TCL interpreter that invoked this command */
  int objc,              /* Number of arguments */
  Tcl_Obj *CONST objv[]  /* Command arguments */
...
*/
SQLITE_METHOD int Sqlitetest_blob_Init(Tcl_Interp *interp){
#ifndef SQLITE_OMIT_INCRBLOB
  static struct {
     char *zName;
