...
void ReportTable(
  ...
  */
  ...
  fprintf(out,"static SQLITE_CONSTANT const YYACTIONTYPE yy_action[] = {\n"); lineno++;
  for(i=j=0; i<n; i++){
  ...
  fprintf(out,"static SQLITE_CONSTANT const YYCODETYPE yy_lookahead[] = {\n"); lineno++;
  for(i=j=0; i<n; i++){
  ...
  fprintf(out, "static SQLITE_CONSTANT const %s yy_shift_ofst[] = {\n",
  ...
  fprintf(out, "static SQLITE_CONSTANT const %s yy_reduce_ofst[] = {\n",
  ...
  fprintf(out, "static SQLITE_CONSTANT const YYACTIONTYPE yy_default[] = {\n"); lineno++;
  n = lemp->nxstate;
  lemp->tablesize += n*szActionType;
  for(i=j=0; i<n; i++){
    stp = lemp->sorted[i];
