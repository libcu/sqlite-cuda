...
*/
static SQLITE_METHOD void tclDequote(char *z){
  char q = z[0];
...
*/
static SQLITE_METHOD int tclConnect(
  sqlite3 *db,
  void *pAux,
...
static SQLITE_METHOD int tclDisconnect(sqlite3_vtab *pVtab){
...
*/
static SQLITE_METHOD int tclOpen(sqlite3_vtab *pVTab, sqlite3_vtab_cursor **ppCursor){
  tcl_cursor *pCur;
...
** Close a tcl cursor.
*/
static SQLITE_METHOD int tclClose(sqlite3_vtab_cursor *cur){
...
static SQLITE_METHOD int tclNext(sqlite3_vtab_cursor *pVtabCursor){
...
static SQLITE_METHOD int tclFilter(
...
static SQLITE_METHOD int tclColumn(
  sqlite3_vtab_cursor *pVtabCursor, 
  sqlite3_context *ctx, 
  int i
){
...
static SQLITE_METHOD int tclRowid(sqlite3_vtab_cursor *pVtabCursor, sqlite_int64 *pRowid){
  tcl_cursor *pCsr = (tcl_cursor*)pVtabCursor;
  *pRowid = sqlite3_column_int64(pCsr->pStmt, 0);
  return SQLITE_OK;
}

static SQLITE_METHOD int tclEof(sqlite3_vtab_cursor *pVtabCursor){
  tcl_cursor *pCsr = (tcl_cursor*)pVtabCursor;
  return (pCsr->pStmt==0);
}

static SQLITE_METHOD int tclBestIndex(sqlite3_vtab *tab, sqlite3_index_info *pIdxInfo){
...
*/
static SQLITE_CONSTANT sqlite3_module tclModule = {
  0,                         /* iVersion */
  tclConnect,
  tclConnect,
  tclBestIndex,
...
*/
extern SQLITE_METHOD int getDbPointer(Tcl_Interp *interp, const char *zA, sqlite3 **ppDb);

/*
** Register the echo virtual table module.
*/
static SQLITE_METHOD int SQLITE_TCLAPI register_tcl_module(
...
*/
SQLITE_METHOD int Sqlitetesttcl_Init(Tcl_Interp *interp){
#ifndef SQLITE_OMIT_VIRTUALTABLE
  static struct {
     char *zName;
