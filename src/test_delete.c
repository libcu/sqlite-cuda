...
*/
static SQLITE_METHOD void sqlite3Delete83Name(char *z){
  int i, sz;
  sz = (int)strlen(z);
...
*/
static SQLITE_METHOD int sqlite3DeleteUnlinkIfExists(
  sqlite3_vfs *pVfs,
  const char *zFile, 
  int *pbExists
){
...
*/
SQLITE_METHOD SQLITE_API int sqlite3_delete_database(
