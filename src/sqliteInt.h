...
*/
  ...
  SQLITE_METHOD void sqlite3Coverage(int);
...
*/
  ...
  extern SQLITE_FIELD int sqlite3OSTrace;
...
#ifdef __cplusplus
#define sqlite3InitInfo sqlite3::sqlite3InitInfo
#endif /* __cplusplus */
...
#ifdef __cplusplus
#define AggInfo_col AggInfo::AggInfo_col
#define AggInfo_func AggInfo::AggInfo_func
#endif /* __cplusplus */
...
#ifdef __cplusplus
#define ExprList_item ExprList::ExprList_item
#endif /* __cplusplus */
...
#ifdef __cplusplus
#define IdList_item IdList::IdList_item
#endif /* __cplusplus */
...
#ifdef __cplusplus
#define SrcList_item SrcList::SrcList_item
#endif /* __cplusplus */
...
#ifdef __cplusplus
#define yColCache Parse::yColCache
#endif /* __cplusplus */
...
SQLITE_METHOD int sqlite3SelectWalkNoop(Walker*, Select*);
SQLITE_METHOD int sqlite3SelectWalkFail(Walker*, Select*);
#ifdef SQLITE_DEBUG
SQLITE_METHOD void sqlite3SelectWalkAssert2(Walker*, Select*);
#endif
...
#define SQLITE_CANTOPEN_BKPT sqlite3CantopenError(__LINE__)
  ...
  SQLITE_METHOD int sqlite3CorruptPgnoError(int,Pgno);
...
SQLITE_METHOD int sqlite3IsIdChar(u8);
#endif
...
SQLITE_METHOD char *sqlite3DbSpanDup(sqlite3*,const char*,const char*);
...
SQLITE_METHOD const sqlite3_mem_methods *sqlite3MemGetMemsys5(void);
#undef SQLITE_ENABLE_MEMSYS3
#endif
#ifdef SQLITE_ENABLE_MEMSYS3
SQLITE_METHOD const sqlite3_mem_methods *sqlite3MemGetMemsys3(void);
#endif
...
SQLITE_METHOD int sqlite3LookasideUsed(sqlite3*,int*);
...
SQLITE_METHOD void sqlite3MutexWarnOnContention(sqlite3_mutex*);
#else
...
SQLITE_METHOD void sqlite3ExprListSetSpan(Parse*,ExprList*,const char*,const char*);
...
SQLITE_METHOD void sqlite3AddDefaultValue(Parse*,Expr*,const char*,const char*);
...
SQLITE_METHOD Expr *sqlite3LimitWhere(Parse*,SrcList*,Expr*,ExprList*,Expr*,char*);
#endif
SQLITE_METHOD void sqlite3DeleteFrom(Parse*, SrcList*, Expr*, ExprList*, Expr*);
SQLITE_METHOD void sqlite3Update(Parse*, SrcList*, ExprList*,Expr*,int,ExprList*,Expr*);
...
SQLITE_METHOD int sqlite3ExprCompare(Parse*,Expr*, Expr*, int);
SQLITE_METHOD int sqlite3ExprCompareSkip(Expr*, Expr*, int);
SQLITE_METHOD int sqlite3ExprListCompare(ExprList*, ExprList*, int);
SQLITE_METHOD int sqlite3ExprImpliesExpr(Parse*,Expr*, Expr*, int);
...
SQLITE_METHOD void sqlite3EndTransaction(Parse*,int);
...
SQLITE_METHOD int sqlite3ExprIsConstantOrGroupBy(Parse*, Expr*, ExprList*);
...
SQLITE_METHOD void sqlite3MaterializeView(Parse*, Table*, Expr*, ExprList*,Expr*,int);
#endif
...
SQLITE_METHOD int sqlite3ExprCollSeqMatch(Parse*,Expr*,Expr*);
...
extern SQLITE_CONSTANT const unsigned char sqlite3OpcodeProperty[];
extern SQLITE_CONSTANT const char sqlite3StrBINARY[];
extern SQLITE_CONSTANT const unsigned char sqlite3UpperToLower[];
extern SQLITE_CONSTANT const unsigned char sqlite3CtypeMap[];
extern SQLITE_CONSTANT const Token sqlite3IntTokens[];
extern SQLITE_FIELD SQLITE_WSD struct Sqlite3Config sqlite3Config;
extern SQLITE_CONSTANT FuncDefHash sqlite3BuiltinFunctions;
#ifndef SQLITE_OMIT_WSD
extern SQLITE_FIELD int sqlite3PendingByte;
#endif
#endif
#ifdef VDBE_PROFILE
extern SQLITE_FIELD sqlite3_uint64 sqlite3NProfileCnt;
#endif
...
SQLITE_METHOD void sqlite3Put4byte(u8*, u32);
  ...
  SQLITE_METHOD int sqlite3ParserCoverage(FILE*);
#endif
...
SQLITE_METHOD int sqlite3DbpageRegister(sqlite3*);
#endif
...
#ifndef SQLITE_OMIT_COMPILEOPTION_DIAGS
SQLITE_METHOD const char **sqlite3CompileOptions(int *pnOpt);
#endif
